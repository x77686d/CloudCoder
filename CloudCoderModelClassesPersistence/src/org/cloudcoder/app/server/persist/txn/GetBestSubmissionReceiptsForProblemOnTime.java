 ...
 * for a given problem.
 */
public class GetBestSubmissionReceiptsForProblemOnTime
	 ...
	 */
	public GetBestSubmissionReceiptsForProblemOnTime(int section, Problem problem) {
	...
	public List<UserAndSubmissionReceipt> run(Connection conn)
			throws SQLException {
		return Queries.doGetBestSubmissionReceiptsOnTime(conn, problem, section, this);
	}
